...
bool downcast_call(Object &obj, const T &func) {
  switch (obj.get_id()) {
    ...
    case internalLinkTypeUnknownDeepLink::ID:
      ...
      return true;
    case internalLinkTypeVoiceChat::ID:
      func(static_cast<internalLinkTypeVoiceChat &>(obj));
      return true;
    case invoice::ID:
    ...
    case pushMessageContentChatChangeTitle::ID:
      ...
      return true;
    case pushMessageContentChatChangeTheme::ID:
      func(static_cast<pushMessageContentChatChangeTheme &>(obj));
      return true;
